...
export default function NewAdminUserPage() {
  ...
  const createMutation = useMutation({
    mutationFn: async () => {
      ...
      return apiFetch<{ user: unknown }>('/users', {
        method: 'POST',
        token,
        body: JSON.stringify({
          email,
  ...
  return (
    <div className="min-h-screen bg-zinc-50 text-zinc-900">
      ...
      <div className="mx-auto max-w-7xl px-6 py-10">
        ...
        <h1 className="mt-3 text-3xl font-semibold text-zinc-900">Create user</h1>
        ...
        >
          ...
          <div>
            ...
            <div className="mt-2 text-sm text-zinc-500">
              Admin always has ALL workspaces.
            </div>
          </div>
          ...
          {role !== 'admin' ? (
            <div className="rounded-md border border-zinc-200 bg-white p-4">
              ...
              <div className="mt-2 text-sm text-zinc-600">
                If disabled, you must select workspaces below.
              </div>
          ...
          {createMutation.isError ? (
            <div className="rounded-md bg-red-50 p-3 text-sm text-red-700">
              {formatApiError(createMutation.error, 'Failed to create user.')}
            </div>
          ) : null}
